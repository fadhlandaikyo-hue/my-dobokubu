...
const projectsRaw = [
  {
    ...
    type: "法面",
    images: [{ src: "/building.svg", takenAt: "2026-03-01" }],
    badgeLabel: null,
    badgeClass: null,
    completed: false,
    description: `-`,
  ...
  },
  {
    ...
    type: "",
    images: [{ src: "/building.svg", takenAt: "2026-05-09" }],
    badgeLabel: null,
    badgeClass: null,
    completed: true,
    description: `管路工
  ...
  },
  {
    ...
    type: "-",
    images: [{ src: "/building.svg", takenAt: "2026-09-30" }],
    badgeLabel: null,
    badgeClass: null,
    completed: true,
    description: `-`,
  ...
  },
  {
    ...
    type: "-",
    images: [{ src: "/building.svg", takenAt: "2026-02-20" }],
    badgeLabel: null,
    badgeClass: null,
    completed: true,
    description: `河川土工
  ...
  },
  {
    ...
    type: "-",
    images: [{ src: "/building.svg", takenAt: "2026-03-10" }],
    badgeLabel: null,
    badgeClass: null,
    completed: true,
  ...
  },
  {
    ...
    type: "-",
    images: [{ src: "/building.svg", takenAt: "2026-02-06" }],
    badgeLabel: null,
    badgeClass: null,
    completed: true,
    description: `-`,
