...
// Temporary placeholder while the equipment page is being prepared.
// const projectsRaw = [{}];
</script>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition duration-300 group">
              <div class="relative h-48 bg-gray-100">
                <img src="/img/pengukuroksigen.jpg" class="w-full h-full object-cover" alt="Excavator" width="1280" height="720" loading="lazy" decoding="async">
              ...
              <div class="p-5">
                <div class="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p class="text-xs text-gray-500 font-mono">その他</p>
                  </div>
                </div>

                <div class="mt-4 space-y-2">
                  <div class="flex justify-between text-sm border-b border-gray-100 pb-2">
                    <span class="text-gray-500">その他</span>
                    <span class="font-medium text-gray-900">その他</span>
                  </div>
                  <div class="flex justify-between text-sm border-b border-gray-100 pb-2">
                    <span class="text-gray-500">その他</span>
                    <span class="font-medium text-gray-900">その他</span>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition duration-300 group">
              <div class="relative h-48 bg-gray-100">
                <img src="/img/smithanmer.jpg" class="w-full h-full object-cover" alt="Tower Crane" width="1280" height="720" loading="lazy" decoding="async">
                <div class="absolute top-3 right-3">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200 shadow-sm">
                                    <span class="w-2 h-2 mr-1.5 bg-green-500 rounded-full animate-pulse"></span>
                                    その他
              ...
              <div class="p-5">
                <div class="flex justify-between items-start mb-2">
                  <div>
                    <h3 class="text-lg font-bold text-gray-900">その他</h3>
                    <p class="text-xs text-gray-500 font-mono">その他CTH</p>
                  </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition duration-300 group ring-2 ring-red-50">
              <div class="relative h-48 bg-gray-100">
                <div class="absolute inset-0 bg-red-500 bg-opacity-10 pointer-events-none"></div>
                <img src="/img/laser.jpg" class="w-full h-full object-cover grayscale" alt="Dump Truck" width="1280" height="720" loading="lazy" decoding="async">
                <div class="absolute top-3 right-3">
              ...
              <div class="p-5">
                <div class="flex justify-between items-start mb-2">
                  <div>
                    <h3 class="text-lg font-bold text-gray-900">その他</h3>
                    <p class="text-xs text-gray-500 font-mono">その他: LS-1</p>
                  </div>
                </div>
                ...
                <div class="mt-4 space-y-2">
                  ...
                  <div class="flex justify-between text-sm border-b border-gray-100 pb-2">
                    <span class="text-gray-500">その他</span>
                    <span class="font-medium text-red-600">その他</span>
                  </div>
                  <div class="flex justify-between text-sm pt-1">
                    <span class="text-gray-500">その他</span>
                    <span class="font-medium text-gray-900">その他</span>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition duration-300 group">
              <div class="relative h-48 bg-gray-100">
                <img src="/img/usb.jpg" class="w-full h-full object-cover" alt="Mixer" width="1280" height="720" loading="lazy" decoding="async">
                <div class="absolute top-3 right-3">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200 shadow-sm">
                                    <span class="w-2 h-2 mr-1.5 bg-green-500 rounded-full animate-pulse"></span>
                                    その他
              ...
              <div class="p-5">
                <div class="flex justify-between items-start mb-2">
                  <div>
                    <h3 class="text-lg font-bold text-gray-900">USB <>その他</h3>
                    <p class="text-xs text-gray-500 font-mono">その他: USB-C</p>
                  </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition duration-300 group">
              <div class="relative h-48 bg-gray-100">
                <img src="/img/kui-navi1.jpg" class="w-full h-full object-cover" alt="Total Station" width="1280" height="720" loading="lazy" decoding="async">
                <div class="absolute top-3 right-3">
              ...
              <div class="p-5">
                <div class="flex justify-between items-start mb-2">
                  <div>
                    <h3 class="text-lg font-bold text-gray-900">その他</h3>
                    <p class="text-xs text-gray-500 font-mono">その他: ATP 2-1</p>
                  </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition duration-300 group">
              <div class="relative h-48 bg-gray-100">
                <img src="/img/total-station.jpg" class="w-full h-full object-cover" alt="Roller" width="1280" height="720" loading="lazy" decoding="async">
                <div class="absolute top-3 right-3">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200 shadow-sm">
                                    <span class="w-2 h-2 mr-1.5 bg-green-500 rounded-full animate-pulse"></span>
                                    その他
              ...
              <div class="p-5">
                <div class="flex justify-between items-start mb-2">
                  <div>
                    <h3 class="text-lg font-bold text-gray-900">その他</h3>
                    <p class="text-xs text-gray-500 font-mono">その他: T-2</p>
                  </div>
                </div>
